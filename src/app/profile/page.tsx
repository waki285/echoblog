    ...
    <main className="content">
      ...
      <div className="max-w-[1200px] w-full mx-auto p-4">
        ...
        <Section className="mt-4">
          <Image
            src={SuzuneuCover}
            alt="すずねーう suzuneu.com / @suzuneu"
            width={600}
            priority
          />
          <Toc />
          <H id="selfintro" className="mt-4">
            自己紹介
          </H>
          <Section>
            <p>
              すずねーうです。自称プログラマーです。主に Discord Bot
              やウェブサイト (フロントエンド/バックエンド) の開発をしています。
            </p>
            <p>
              私の PGP 公開鍵を
              <TextLink href="/pgp">ここから取得できます。</TextLink>
            </p>
          </Section>
          <H id="skills">スキル</H>
          <Section>
